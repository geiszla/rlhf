...
feedback_directory = path.join(script_path, "..", "feedback")
feedback_path = path.join(feedback_directory, f"{FEEDBACK_ID}.pkl")

# Load the pretrained "expert" model
# PPO
# expert_model = PPO.load(
#     path.join(
#         script_path, "..", "experts", "ppo", "HalfCheetah-v3_1", "HalfCheetah-v3.zip"
#     ),
#     custom_objects={
#         "learning_rate": 0.0,
...
def main():
    ...
    # Save feedback
    Path(feedback_directory).mkdir(parents=True, exist_ok=True)
